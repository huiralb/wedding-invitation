...
var countDownDate = new Date("Dec 10, 2022 10:00:00").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='container'><div class='days block'>"+ days + "<br>Jam</div>" + "<div class='hours block'>" + hours + "<br>Jam</div>" + "<div class='minutes block'>" + minutes + "<br>menit</div>" + "<div class='seconds block'>" + seconds + "<br>detik</div></div>";
